  ...
  render() {
    return (
      <div className ="team-main">
        <p className ='text-med-black' >Team</p>
        ...
        <div className ="img-with-text padding-top-small">
            ...
            <span className=" blue-cirlce"></span></div>
                <p className ='text-center'><b>Mikel Palokaj</b></p>
            ...
            <div className ='text-center'>
            <span className=" blue-cirlce"></span></div>
                <p className ='text-center'><b>Mark Laagland</b></p>
            ...
            <div className ='text-center'>
            <span className=" blue-cirlce"></span></div>
                <p className ='text-center'><b>Kent de Bruin</b></p>
