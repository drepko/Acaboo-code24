    ...
    render() {
        ...
        return (
            <div className='signup-login'>
                    <h1>Sign up for Acaboo</h1><br /><br />
                    <h3>Fill in details</h3><br />
                    ...
                    >
                        ...
                        <Form.Group>
                            <div id="checkbox-flex">
                                ...
                                <div className="jc-start">
                                    <Form.Label id="flex-label">I accept Acaboo’s T&Cs and Privacy Policy </Form.Label>
                                </div>
                            </div>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <p>Already using Acaboo? <Link to="/login">Login</Link></p>
